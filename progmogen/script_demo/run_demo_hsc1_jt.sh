...
save_fig_dir="result/demo_jt/${save_tag}_n${num_samples_limit}/${eval_method}_${ret_type}_npy"

task_config="jt_task_hsc1_config"


###############################################################################
# generate motion
###############################################################################
python3 tasks/run_demo_simple_jt.py \
    --use_ddim_tag 1 \
...
project_dir="/path/to/ProgMoGen-jittor"
