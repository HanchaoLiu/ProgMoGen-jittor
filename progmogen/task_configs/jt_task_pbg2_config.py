...
def f_loss(self, sample, sample_0, it):
    ...
    def loss_two_hands(sample, margin):
        ...
        d_margin = jt.ones_like(dd)*margin
...
def f_eval(self, sample, sample_0):
    ...
    loss_two_hands_val  = loss_two_hands(sample, margin=0.4)
    loss_massctr_val    = loss_mass_ctr(sample)
    loss = (loss_two_hands_val + loss_massctr_val)/2
